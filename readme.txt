To calcualte the OSD sheets of ZM format:
	...
	* Execute the query given in billing_query.txt file but change the ccc_code accordingly 
	and change the sch date accordingly.
	...
	* Execute the query given in dd_query.txt file but change the ccc_code accordingly
	* Save the output in file in C:\Python34\zm_format\dd.csv
